package com.geekydroid.habbitlog.adapters
...
class HabitAdapter(
    private val habitOnClickListener: HabitItemOnClickListener,
    ...
    override fun onBindViewHolder(holder: HabitAdapter.ViewHolder, position: Int) {
        val currentHabit = currentList[position]

        holder.habitName.text = currentHabit.habitName
        holder.habitCreatedOn.text = "Created On ${currentHabit.createdOnFormatted}"
        holder.habitTime.text =
            Util.formatTime(
        ...
        holder.habitCard.setOnClickListener {
            habitOnClickListener.onItemClick(currentHabit)
        }
    }
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val habitName = itemView.findViewById<TextView>(R.id.tv_habit_name)
        val habitCreatedOn = itemView.findViewById<TextView>(R.id.tv_created_on)
        val habitTime = itemView.findViewById<TextView>(R.id.tv_habit_time)
        val habitCard = itemView.findViewById<MaterialCardView>(R.id.habit_card)
    ...
    interface HabitItemOnClickListener {
